 ...
 * @author mtandrup
 */
public class CommitListPanel implements WebPanel {
    private final StashAuthenticationContext stashAuthenticationContext;
    private final ActiveObjects ao;

    public CommitListPanel(StashAuthenticationContext stashAuthenticationContext, ActiveObjects ao) {
    ...
    public String getHtml(Map<String, Object> map) {
        ...
        if (pushedBy != null && pushedBy.getEmailAddress() != null) {
            ...
            if (!pushedBy.getEmailAddress().equalsIgnoreCase(author.getEmailAddress())) {
                return "<span class=\"aui-icon aui-icon-warning\">Warning</span> "
                        + pushedBy.getEmailAddress();
            } else {
                return "Author";
            }
        }
